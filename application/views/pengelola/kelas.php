                                  ...
                                  <?php
                                   ...
                                   foreach ($record as $r) {
                                     echo "<tr class='odd gradeX'>
                                           <td>$no</td>
                                           <td>$r->nama_kelas</td>
                                           <td width='10'>".anchor("pengelola/kelas/edit/".$r->id_kelas,"<span class='fa fa-pencil-square-o' aria-hidden='true'></span>",array('title'=>'edit data'))."</td>
                                           <td width='10'>".anchor("pengelola/kelas/delete/".$r->id_kelas,"<span class='glyphicon glyphicon-trash' aria-hidden='true'></span>",array('title'=>'delete data'))."</td>
                                     </tr>";
                                     $no++;
                                   }
                                   ?>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <!-- form start -->
                          <?php
                            form_open('pengelola/kelas/post');
                          ?>
                          <form method="post" accept-charset="utf-8">
                              <div class="box-body">
                                  <div class="form-group">
                                      <label>Kelas</label>
                                      <input class="form-control" placeholder="masukkan nama kelas" name="nama_kelas" type="text" required>
                                  </div>
                              </div><!-- /.box-body -->

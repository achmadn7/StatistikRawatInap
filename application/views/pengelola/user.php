                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php
                              echo anchor('pengelola/user/post','Tambah',array('class'=>'btn btn-success btn-sm'));
                            ?>
                        </div>
                        <!-- /.panel-heading -->
                                   ...
                                   <?php
                                    ...
                                    foreach ($record as $r) {
                                      echo "<tr class='odd gradeX'>
                                            ...
                                            <td>$r->level</td>
                                            <td>$r->created_at  </td>
                                            <td width='10'>".anchor("pengelola/user/edit/".$r->id_user,"<span class='fa fa-pencil-square-o' aria-hidden='true'></span>",array('title'=>'edit data'))."</td>
                                            <td width='10'>".anchor("pengelola/user/delete/".$r->id_user,"<span class='glyphicon glyphicon-trash' aria-hidden='true'></span>",array('title'=>'delete data'))."</td>

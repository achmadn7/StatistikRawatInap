                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="<?php echo base_url()?>pengelola/tambahuser" type="button" class="btn btn-success">Tambah</a>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="<?php echo base_url()?>pengelola/" type="button" class="btn btn-success">Edit</a> | <a href="<?php echo base_url()?>pengelola/" type="button" class="btn btn-success">Delete</a></td>
                                    </tr>

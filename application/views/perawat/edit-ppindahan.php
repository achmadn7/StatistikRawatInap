                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      <div class="input-append date form_datetime">
                                          <input class="form-control" type="text" value="<?php echo $row['tgl_pindahan'];?>" name="tgl_pindahan" value="" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dari_ruang" class="form-control">
                                          ...
                                          foreach ($ruang as $r) {
                                            ...
                                            echo $r->nama_ruang==$row['dari_ruang']?'selected':'';
                                            echo">$r->nama_ruang</option>";
                                          }
                                          ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dari_kelas" class="form-control">
                                          ...
                                          foreach ($kelas as $k) {
                                            ...
                                            echo $k->nama_kelas==$row['dari_kelas']?'selected':'';
                                            echo">$k->nama_kelas</option>";
                                          }
                                          ?>
                                        </select>

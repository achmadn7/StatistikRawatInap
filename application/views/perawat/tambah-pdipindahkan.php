    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>perawat/dashboard">Sistem InformasiIndikator Pelayanan</a>
            </div>
            <!-- Top Menu Items -->
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      <div class="input-append date form_datetime">
                                          <input class="form-control" type="text" name="tgl_dipindahkan" value="" readonly>
